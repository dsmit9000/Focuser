...
export LoadConfigTBL_focuser_Bank1
export LoadConfigTBL_focuser_Bank0
export LoadConfigTBL_focuser_Ordered
AREA lit(rom, rel)
LoadConfigTBL_focuser_Bank0:
...
LoadConfigTBL_focuser_Ordered:
;  Ordered Global Register values
	M8C_SetBank0
	mov	reg[00h], 00h		; Port_0_Data register (PRT0DR)
	M8C_SetBank1
	mov	reg[00h], 3ch		; Port_0_DriveMode_0 register (PRT0DM0)
