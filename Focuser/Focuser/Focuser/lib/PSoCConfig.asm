...
export LoadConfig_focuser
export _LoadConfig_focuser
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_focuser
	lcall	LoadConfigTBL_focuser_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration focuser
;
;    Load configuration registers for focuser.
...
_LoadConfig_focuser:
 LoadConfig_focuser:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_focuser_Bank0
    mov     X, <LoadConfigTBL_focuser_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_focuser_Bank1
    mov     X, <LoadConfigTBL_focuser_Bank1
